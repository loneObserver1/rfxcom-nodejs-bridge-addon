...
if [ -z "$MQTT_HOST" ] || [ -z "$MQTT_USER" ]; then
    ...
    if bashio::services.available mqtt; then
        ...
        bashio::log.info "✅ Paramètres MQTT récupérés automatiquement depuis Home Assistant"
        ...
        bashio::log.warning "⚠️ Service MQTT non disponible, utilisation des valeurs par défaut"
